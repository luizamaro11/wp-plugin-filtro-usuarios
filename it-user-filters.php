...
function add_registration_date_filter( $which ) {
...
function filter_users_by_state_section( $query ) {
    global $pagenow;

    if ( is_admin() && $pagenow === 'users.php') {
        $top = isset($_GET['state_top']) ? $_GET['state_top'] : null;
        $bottom = isset($_GET['state_bottom']) ? $_GET['state_bottom'] : null;
...
add_filter('pre_get_users', 'filter_users_by_state_section');
